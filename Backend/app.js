...
try {
	...
	const TaskChain = dwsClient.taskChain.createTaskChainClient(services.dwf, loopBackUrl, rejectUnauth);

	/*
	passport.use('JWT', new dwsClient.helpers.JWTHybridStrategy(services.uaa));
